...
def print_usage():
    ...
    print("\nExamples:")
    print("  python main.py server                                       # Run the webhook server")
    print("  python main.py cli fetch-and-send --limit=5                 # Fetch tweets and forward to Telegram")
    print("  python main.py cli dump-tweets --file=tweets.json           # Fetch tweets and save to file")
    print("  python main.py cli send-from-file --file=tweets.json                   # Send tweets with auto-matching")
    print("\nFor more detailed help on CLI options, run:")
    print("  python main.py cli                   # Show available CLI subcommands")
    print("  python main.py cli fetch-and-send    # Show options for the fetch-and-send subcommand")
    print("  python main.py cli dump-tweets       # Show options for the dump-tweets subcommand")
    print("  python main.py cli send-from-file    # Show options for the send-from-file subcommand")
