...
def downgrade() -> None:
    ...
    try:
        op.drop_index(
            "idx_translated_messages_telegram_message_id",
            table_name="translated_messages",
        )
        op.drop_index(
            "idx_translated_messages_tweet_id", table_name="translated_messages"
        )
        op.drop_index(
            "idx_translated_messages_parent_tweet_id", table_name="translated_messages"
        )
